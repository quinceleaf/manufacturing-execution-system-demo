# Generated by Django 3.2 on 2021-04-11 00:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', django_fsm.FSMField(choices=[('CURRENT', 'Current'), ('NAN', 'No Approval Necessary'), ('LAPSED', 'Lapsed')], default='CURRENT', max_length=50, verbose_name='Status')),
                ('subscription_level', models.CharField(default='FREE', max_length=24, verbose_name='Subscription Level')),
            ],
            options={
                'ordering': ['name'],
                'permissions': [('change_tenant_status', 'Can change status of tenant')],
            },
        ),
        migrations.CreateModel(
            name='SiteSettings',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requests', to='users.organization')),
            ],
            options={
                'abstract': False,
            },
